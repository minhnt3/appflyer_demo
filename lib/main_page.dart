...
class MainPageState extends State<MainPage> {
  ...
  void initState() {
    ...
    final AppsFlyerOptions options = AppsFlyerOptions(
      afDevKey: 'Zmdm4rU6PKrndcDbfMBKLc',
      appId: 'com.example.test_project',
  ...
  Future<bool?> logEvent(String eventName, Map eventValues) {
    ...
    _appsflyerSdk?.logEvent('user_click_viblo_banner', {
      'from_example_app': true,
    }).then((value) => print('logevent successssssssssss $value'));
